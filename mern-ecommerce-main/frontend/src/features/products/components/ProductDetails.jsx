    ...
    return (
        <>
            {!(productFetchStatus === 'rejected' && reviewFetchStatus === 'rejected') && (
                <Stack sx={{ justifyContent: 'center', alignItems: 'center', rowGap: "2rem", backgroundColor: 'black', color: "white" }}>
                        ...
                        <Stack>
                            ...
                            >
                                    ...
                                    <Stack sx={{ width: "100%", height: "100%" }}>
                                        {is1420 ? (
                                            ...
                                            <Box
                                                ...
                                                alt={`${product?.title} image`}
                                                sx={{ width: "100%", height: "100%", objectFit: "contain", aspectRatio: 1 / 1 }}
                                            />
                                        )}
                                    </Stack>
                                </Stack>
                                ...
                                >
                                    ...
                                    <Stack rowGap=".25rem">
                                        <Typography variant="h6" fontWeight={300}>{product?.title}</Typography>
                                        <Stack
                                            sx={{
                                                flexDirection: "row",
                                                columnGap: is340 ? ".25rem" : ".5rem",
                                                alignItems: "center",
                                                flexWrap: 'wrap',
                                                rowGap: '.25rem'
                                            }}
                                        >
                                            ...
                                            <Typography>
                                                ({totalReviews === 0 ? "No reviews" : totalReviews === 1 ? "1 Review" : `${totalReviews} Reviews`})
                                            </Typography>
                                            <Typography color={
                                                product?.stockQuantity <= 10 ? "error" :
                                                    product?.stockQuantity <= 20 ? "orange" :
                                                        "green"
                                            }>
                                    ...
                                    <Stack mt={3} sx={{ justifyContent: "center", alignItems: 'center', border: "1px #D4AF37 solid", borderRadius: "7px", color: "#D4AF37" }}>
                            ...
                            <Stack width={is1420 ? "auto" : '88rem'} p={is480 ? 2 : 0} mb={10}>
