      ...
      <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
        ...
        <Stack mt={4} spacing={2} width={is480 ? "95vw" : '28rem'} component={'form'} noValidate onSubmit={handleSubmit(handleLogin)}>
          ...
          <motion.div whileHover={{ scale: 1.020 }} whileTap={{ scale: 1 }}>
            ...
            }} loading={status === 'pending'} type='submit' variant='contained' > Login</LoadingButton>
          </motion.div>
          ...
          <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'} flexWrap={'wrap-reverse'} >
            <MotionConfig whileHover={{ x: 2 }} whileTap={{ scale: 1.050 }}>
              ...
              <motion.div>
                <Typography sx={{ textDecoration: "none", color: "text.primary" }} to={'/signup'} component={Link}>Don't have an account? <span style={{ color: "#d4af37" }}>Register</span></Typography>
              </motion.div>
            </MotionConfig>
