...
const sortOptions = [
    { name: "Price: low to high", sort: "price", order: "asc", id: "lowToHigh" },
    { name: "Price: high to low", sort: "price", order: "desc", id: "highToLow" },
];
...
export const AdminDashBoard = () => {
    ...
    return (
        <>
            <motion.div style={{ position: "fixed", backgroundColor: "#D4AF37", height: "100vh", padding: '1rem', overflowY: "scroll", width: is500 ? "100vw" : "30rem", zIndex: 500 }} variants={{ show: { left: 0 }, hide: { left: -500 } }} initial={'hide'} transition={{ ease: "easeInOut", duration: .7, type: "spring" }} animate={isProductFilterOpen === true ? "show" : "hide"}>
                                ...
                                <Stack>
                                    ...
                                    <Stack paddingLeft={2} paddingRight={2} flexDirection={'row'} justifySelf={'flex-end'} alignSelf={'flex-end'} columnGap={is488 ? 1 : 2}>
                                        <Button
                                            ...
                                            }} component={Link} to={`/admin/product-update/${product._id}`} variant='contained'>Update</Button>
                                        {
                                            product.isDeleted === true ? (
                                                ...
                                                }} onClick={() => handleProductDelete(product._id)} color='error' variant='outlined'>Delete</Button>
                                            )
                                        }
                                    </Stack>
                                </Stack>
