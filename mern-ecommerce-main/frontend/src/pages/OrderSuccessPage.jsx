...
export const OrderSuccessPage = () => {
  ...
  return (
    <Stack sx={{ bgcolor: "#D4AF37" }} width={'100vw'} height={'100vh'} justifyContent={'center'} alignItems={'center'}>
      <Stack sx={{ bgcolor: "black", color: "white" }} component={Paper} boxShadow={is480 ? 'none' : ""} rowGap={3} elevation={1} p={is480 ? 1 : 4} justifyContent={'center'} alignItems={'center'}>
        ...
        <Stack mt={2} textAlign={'center'} justifyContent={'center'} alignItems={'center'} rowGap={1}>
          ...
          <Typography variant='body2' color='white'>Thankyou for shopping with us❤️</Typography>
        </Stack>
        <Button
          sx={{
            color: "white",
